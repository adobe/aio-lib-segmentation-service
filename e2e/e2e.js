...
let sdkClient = {}
const tenantId = process.env.SegmentationServiceAPI_TENANT_ID
const apiKey = process.env.SegmentationServiceAPI_API_KEY
const accessToken = process.env.SegmentationServiceAPI_ACCESS_TOKEN
